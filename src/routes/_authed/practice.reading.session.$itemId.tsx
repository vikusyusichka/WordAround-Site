  ...
  return (
    <ContentContainer fluid>
      ...
      <div className="mx-auto flex w-full max-w-2xl flex-col gap-5">
        ...
        {state.phase === 'reading' && (
          <>
            <div className="flex flex-col gap-2.5 rounded-3xl border border-(--color-surface) bg-(--color-surface)/95 p-5 shadow-[0_4px_10px_rgba(0,0,0,0.045)] md:p-6">
              <span className="text-[14px] font-bold text-(--color-accent-cyan-text)">{t('reading.session.textLabel')}</span>
              <ReadingTappableText
                text={item.fullText}
