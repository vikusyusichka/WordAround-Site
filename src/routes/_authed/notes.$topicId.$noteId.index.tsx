    ...
    <ContentContainer fluid>
        ...
        actions={
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className={`grid size-11 place-items-center rounded-2xl border border-(--color-auth-field-border) bg-(--color-surface) transition-colors focus-visible:outline-none ${state.isPinned ? 'text-(--color-primary-blue)' : 'text-(--color-muted-text)'}`}
            >
            ...
            <button
              ...
              className={`grid size-11 place-items-center rounded-2xl border border-(--color-auth-field-border) bg-(--color-surface) transition-colors focus-visible:outline-none ${state.isFavorite ? 'text-(--color-accent-amber)' : 'text-(--color-muted-text)'}`}
            >
      ...
      <div className="mx-auto flex w-full max-w-2xl flex-col gap-5">
        ...
        <input
          ...
          autoFocus
          className="w-full rounded-2xl border border-(--color-auth-field-border) bg-(--color-surface) px-4 py-3 text-[20px] font-bold text-(--color-primary-blue-dark) outline-none focus-visible:border-(--color-home-brand)"
        />
